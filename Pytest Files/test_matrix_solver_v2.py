...
answer_matrix = [[1, 0, 0, 3], [0, 1, 0, 5], [0, 0, 1, 7]]  # #of sol'ns = 1

zero_matrix = [[0, 0], [0, 0]]

small_matrix = [[1, 15], [3, 45]]
...
def test_swap_rows_standard():
    test_matrix = [[2, 1, -1, 4], [1, -1, 2, 12], [2, 2, -1, 9]]
    assert swap_rows(test_matrix, 0, 1) == [
        [1, -1, 2, 12],
        [2, 1, -1, 4],
        [2, 2, -1, 9],
    ]
    ...
    test_matrix = [[2, 1, -1, 4], [1, -1, 2, 12], [2, 2, -1, 9]]
    assert swap_rows(test_matrix, 1, 2) == [
        [2, 1, -1, 4],
        [2, 2, -1, 9],
        [1, -1, 2, 12],
    ]
...
def test_multiply_row_standard():
    test_matrix = [[2, 1, -1, 4], [1, -1, 2, 12], [2, 2, -1, 9]]
    assert multiply_row(test_matrix, 0, 2) == [
        [4, 2, -2, 8],
        [1, -1, 2, 12],
        [2, 2, -1, 9],
    ]
    ...
    test_matrix = [[2, 1, -1, 4], [1, -1, 2, 12], [2, 2, -1, 9]]
    assert multiply_row(test_matrix, 2, -10) == [
        [2, 1, -1, 4],
        [1, -1, 2, 12],
        [-20, -20, 10, -90],
    ]
...
def test_add_rows_standard():
    test_matrix = [[2, 1, -1, 4], [1, -1, 2, 12], [2, 2, -1, 9]]
    assert add_rows(test_matrix, 0, 1, 1) == [
        [3, 0, 1, 16],
        [1, -1, 2, 12],
        [2, 2, -1, 9],
    ]
    ...
    test_matrix = [[2, 1, -1, 4], [1, -1, 2, 12], [2, 2, -1, 9]]
    assert add_rows(test_matrix, 2, 1, -5) == [
        [2, 1, -1, 4],
        [1, -1, 2, 12],
        [-3, 7, -11, -51],
    ]
